---
title: Installation
description: How to setup, install and run next-ship.
---

## Initialization

Run the `next-ship` init command:

```package-install
npx next-ship@latest init
```
...
┌  Let's start a next-ship project!
│
...
For more details on the default Prisma configuration (using Neon), refer to the [Database Configuration Guide](https://www.next-ship.com/packages/database#default-configuration).
