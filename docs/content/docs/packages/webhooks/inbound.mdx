...
next-ship has pre-built webhook handlers for several key services.
...
<Info>Configure your local or preview webhook URL in Polar when testing payment events.</Info>
