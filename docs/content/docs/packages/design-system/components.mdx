---
title: Components
description: next-ship offers a default component library by shadcn/ui
---

next-ship contains a design system out of the box powered by [shadcn/ui](https://ui.shadcn.com/).
