...
Here's how to switch from Neon to [Supabase](https://supabase.com) for your `next-ship` project.
...
Now you can run the migration from the root of your `next-ship` project:
